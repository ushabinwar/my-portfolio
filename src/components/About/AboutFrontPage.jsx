    ...
    <section className="min-h-screen w-full bg-[#F8F3E1] text-black p-1  ">
      ...
      <div ref={textRef} className=" ">
        ...
        <div className=" row2 overflow-hidden  ">
          <h1 className="select-none caret-transparent text-[20vw] text-center leading-20 md:text-[12vw] md:leading-28   lg:leading-36 font-[MangoGro] sm:text-[13vw]  lg:text-[10vw] font-black uppercase ">
             LET'S
          </h1>
        </div>
